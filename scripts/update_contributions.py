...
# Used when GitHub API returns incorrect data
...
def fetch_pr_data(owner: str, repo: str, pr_number: int) -> Optional[dict]:
...
def generate_readme_section(org_prs: Dict[str, List[dict]]) -> str:
    ...
    for owner, prs in sorted_orgs:
        ...
        for pr in prs:
            ...
            diff_stats = format_diff_stats(additions, deletions, merged_at, is_merged)
